...
const { data } = await useAsyncData('home', async () => {
	const [news, clients, reviews, banners, products] = await Promise.all([getNews(0), getClients(), getReviews(), getBanners(0), getTopProducts()]);

	return { news, clients, reviews, banners, products };
});
</script>
