			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
				<div class="flex flex-col items-center gap-6 justify-between order-2 lg:order-1 py-10">
					...
					<div class="grid grid-cols-2 bg-black rounded-t-2xl sm:grid-cols-3 gap-4 lg:-mt-[150px]">
						<div class="flex flex-col items-center gap-4 max-w-[180px] sm:p-6">
							<h3 class="text-white text-2xl sm:text-3xl">5</h3>
							...
							<p class="text-white text-center">data sentrov po uzbekistanu</p>
						</div>
				...
				<div class="flex flex-col gap-6 sm:gap-20 py-6 sm:py-14 order-1 lg:order-2">
					<div class="flex flex-col items-start gap-4">
						...
						<h1 class="text-white text-2xl md:text-3xl xl:text-4xl font-medium"><span class="text-primary">Opencloud</span> - Ваш надежный локальный поставщик облачных решений</h1>
