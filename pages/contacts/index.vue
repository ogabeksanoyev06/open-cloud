<template>
	<div class="grid gap-10 pt-4">
		<div class="container flex flex-col items-center gap-10 pb-10">
			<div></div>
			<h1 class="text-lg sm:text-xl md:text-3xl lg:text-4xl font-medium">Контакты</h1>
		</div>
				...
				<div class="container flex flex-col gap-10 sm:gap-20">
					...
					<div class="grid lg:grid-cols-[400px_minmax(0,1fr)] gap-10 lg:items-start">
						<div class="flex flex-col gap-6">
							<h3 class="text-xl sm:text-2xl">Форма для обратной связи</h3>
								...
								<div class="grid gap-4">
									...
									<div class="grid gap-2">
										<VField name="message" rules="required" v-model="form.message">
											...
											<Textarea v-model="form.message" id="message" type="text" placeholder="Сообщение" />
