<template>
	<div class="grid gap-10">
		<div class="flex flex-col gap-10">
			<div></div>
			<h1 class="text-lg sm:text-xl md:text-3xl lg:text-4xl font-medium text-center">Наши кейсы</h1>
		</div>
				...
				<div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
					...
					>
						<div class="max-w-56 max-h-56 flex-shrink-0 overflow-hidden rounded-lg">
							<img :src="item.image" alt="" class="w-full h-full object-cover sm:rounded-[18px_8px_8px_18px]" />
						</div>
