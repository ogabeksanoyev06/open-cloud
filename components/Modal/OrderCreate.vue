			...
			<DialogTrigger as-child>
				<Button class="w-full">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
						<path d="M6.33325 14.166L9.66659 9.99935L6.33325 5.83268" stroke="#272727" stroke-width="1.5"
							stroke-linecap="round" stroke-linejoin="round" />
						<path d="M11.3333 14.166L14.6666 9.99935L11.3333 5.83268" stroke="#272727" stroke-width="1.5"
							stroke-linecap="round" stroke-linejoin="round" />
					</svg>
				</Button>
			</DialogTrigger>
						...
						<div class="grid gap-6">
							...
							<div class="grid gap-2">
								<VField name="phone" rules="required" v-model="form.phone">
									...
									<Input :placeholder="translations['home.phone-input']" v-model="form.phone" v-maska
										data-maska="+998 (##) ###-##-##" />
