		...
		<div class="container shrink-0 relative z-0">
			<div class="relative">
				...
				<div class="overflow-hidden relative z-0">
						...
						<SwiperSlide v-for="news in data" :key="news.id">
							<NuxtLink :to="`/news/${news?.slug}`" class="space-y-4 group">
								...
								<div class="space-y-1">
									...
									<h4 class="text-xl font-medium group-hover:text-green-500 duration-200 line-clamp-4">
										{{ news.title }}
									</h4>
								</div>
							</NuxtLink>
					...
					<div class="swiper-overlay rotate-180 absolute right-0 top-0 bottom-0 w-[228px] z-[1] pointer-events-none"></div>
