		...
		<div class="container flex h-16 sm:h-[100px] items-center">
			<div class="mr-4 lg:mr-1 flex items-center">
				...
				<nav class="hidden lg:flex flex-wrap items-center max-lg:space-x-4 lg:space-x-8 xl:space-x-10 text-base font-normal">
					...
					<NuxtLink :to="localePath('/about-us')" class="transition-300">О компании</NuxtLink>
					<NuxtLink :to="localePath('/calculator')" class="transition-300">Цены</NuxtLink>
					<NuxtLink :to="localePath('/documentation')" class="transition-300">Документация</NuxtLink>
					<NuxtLink :to="localePath('/partners')" class="transition-300">Партнерство</NuxtLink>
					<NuxtLink :to="localePath('/contacts')" class="transition-300">Контакты</NuxtLink>
				</nav>
			</div>
			...
			<SheetContent side="left" class="w-full">
				<div class="flex flex-col h-full justify-between">
					<nav class="flex flex-col gap-8 mt-6">
						...
						<NuxtLink :to="localePath('/calculator')">Цены</NuxtLink>
						<NuxtLink :to="localePath('/about-us')">О компании</NuxtLink>
						<NuxtLink :to="localePath('/documentation')">Документация</NuxtLink>
						<NuxtLink :to="localePath('/partners')">Partners</NuxtLink>
					</nav>
